// Sends mailing-list emails via Resend. Set RESEND_API_KEY (and optionally
// MAIL_FROM) in the environment; without a key, sends are logged and skipped
// so local dev doesn't require an account.

const { Resend } = require('resend');

const resend = process.env.RESEND_API_KEY ? new Resend(process.env.RESEND_API_KEY) : null;
const FROM_EMAIL = process.env.MAIL_FROM || "Andrew's Story Blog <onboarding@resend.dev>";
